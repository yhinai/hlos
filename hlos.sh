...
KERNEL_DIR="${STANDARD_OEM_DIR}/BUILD/KERNEL.PLATFORM.3.0.r13"
QSSI_DIR="${STANDARD_OEM_DIR}/BUILD/LA.QSSI.14.0.r1"
VENDOR_DIR="${STANDARD_OEM_DIR}/BUILD/LA.VENDOR.14.3.3.r1"
